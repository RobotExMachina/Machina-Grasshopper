...
//            pManager.AddPointParameter("Point", "P", "Target location to move to", GH_ParamAccess.item);
//        }
...
//            pManager.AddGenericParameter("Action", "A", "A MoveTo Action", GH_ParamAccess.item);
//        }
...
//            Machina.Vector to = new Machina.Vector(p.X, p.Y, p.Z);
//            Machina.Action mt = Machina.Action.MoveTo(to);
...
//        {
//            get { return new Guid("ae786ee9-e577-42af-8e90-1eefc76bd687"); }
//        }
//    }
//}
