...
namespace MachinaGrasshopper.Bridge
{
    ...
    public class ActionExecuted : GH_Component
    {
        ...
        private List<double?> _externalAxes;
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("RemainingActions", "pendTot", "How many Actions are left in the queue to be executed?", GH_ParamAccess.item);
            pManager.AddNumberParameter("RemainingActionsOnDevice", "pendDev", "How many Actions are left on the device to be executed? This only accounts for the ones that have already been released to it.", GH_ParamAccess.item);
        }
